...
木なので、1 と N とを結ぶ唯一のパスを構成する頂点以外はより近傍の方がとれることに気が付く。したがってこのパスを構成する頂点を両端からとりあうことになるが、これもより近傍の頂点を互いにとることになるので、頂点 0 から bfs , 頂点 N　から bfs をそれぞれ行い、全ての頂点がどちらにより近いのか考えればよいと判断した。なお、とれる数が同数の場合後手が勝利することに注意。
